Question 1 (2 pts): Regarding reproducibility, what is the main point of
writing your own functions and iterations?

Answer: The main point of writing your own functions and iterations is
to reduce the chances of copy and paste errors and also make analyses
more reproducible.

Question 2 (2 pts): In your own words, describe how to write a function
and a for loop in R and how they work. Give me specifics like syntax,
where to write code, and how the results are returned.

Answer: In R, a function is created using the function() command, where
you give the function a name, define the inputs in parentheses, and
write the code inside curly braces {}. The function performs operations
on the inputs and can return a result using the return() statement. A
for loop is used to repeat code multiple times and has the syntax for (i
in sequence) {code}, where the loop variable “i” takes on each value in
the sequence and the code inside the braces is executed for each value.
...
Auburn, AL and New York City a. Subset/filter the Cities.csv data to
include only the latitude and longitude values you need and input as
input to your function. b. The output of your function should be
1367.854 km
...
Question 7 (2 pts):Commit and push a gfm .md file to GitHub inside a
