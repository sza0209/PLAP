...
plotA = ggplot(mycotoxin, aes(x = Treatment, y = DON, fill = Cultivar)) +
  ...
  geom_point(aes(fill = Cultivar), shape = 21, position = position_jitterdodge(dodge.width = 0.9), alpha = 0.6, color = "black") +     # Jittering points, chainging transparency of pounts to 0.6
